...
- Offer Plitzi as a hosted service or SaaS
- Use Plitzi as part of a product or service that generates revenue
- Provide paid hosting, consulting, or managed services based on Plitzi
- Redistribute Plitzi commercially under any brand

---

## What You Get With a Commercial License

- Legal right to use Plitzi commercially
- Optional enterprise support and SLA (if applicable)
- Right to distribute under commercial terms
