    ...
    <section id="benchmarks" className="border-y border-ink-800 bg-ink-900/30">
      <div className="mx-auto max-w-6xl px-5 py-20">
        <SectionHeading
          ...
          subtitle="Other stores can be fine-grained — with selectors or atoms. @plitzi/nexus is path-scoped out of the box, and ships scoped stores and time-travel that most don't."
        />
