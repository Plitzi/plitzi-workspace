...
const GuidesDataFetching = () => (
  <Prose>
    <p>
      sdk-store ships <code>createAsync</code> — a primitive that runs a fetch, lands the result in the store, and
    ...
    <CodeBlock
      code={`import { createAsync, useAsync } from '@plitzi/sdk-store';
...
import { useAsyncValue } from '@plitzi/sdk-store';
