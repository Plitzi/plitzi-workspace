...
const GuidesNextJs = () => (
  <Prose>
    <p>
      sdk-store works with Next.js (both Pages and App Router) without special configuration. The store is SSR-safe by
...
// app/providers.tsx
import { persistMiddleware } from '@plitzi/sdk-store';
