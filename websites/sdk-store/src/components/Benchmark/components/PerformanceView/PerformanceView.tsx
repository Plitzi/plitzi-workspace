...
const PerformanceView = () => (
  <div className="space-y-6">
    ...
    <p className="mx-auto max-w-3xl text-center text-xs leading-relaxed text-zinc-600">
      ...
      entirely on a <em>normalized map</em> edit, while every immutable store — sdk-store, Zustand, Redux — pays to copy
      the changed container; on <em>hot</em> and <em>fan-out</em> notification throughput decides it. sdk-store stays
