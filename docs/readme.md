...
Las notas que antes estaban en este archivo se movieron a [es/local-setup.md](./es/local-setup.md) y [en/local-setup.md](./en/local-setup.md) (servidores dev y, para maintainers, hosts/HTTPS), y los pasos de publicación a [es/releases.md](./es/releases.md) y [en/releases.md](./en/releases.md).
