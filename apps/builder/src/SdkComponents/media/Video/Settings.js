  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col p-2">
          ...
          <div className="flex flex-col">
            ...
            {src && (
              <div className="flex items-center justify-center p-2 mt-2 border rounded border-gray-300 relative">
                ...
                <video className="w-full h-full rounded" src={src} autoPlay playsInline loop muted>
                  <track kind="captions" />
                </video>
              </div>
            )}
        ...
        <div className="flex items-center mt-4">
          <Checkbox id="loop" checked={loop} onChange={handleChangeChecked('loop')} className="rounded mr-2" />
          <label htmlFor="loop" className="cursor-pointer select-none">
            Loop
          </label>
        </div>
        <div className="flex items-center mt-4">
          <Checkbox id="muted" checked={muted} onChange={handleChangeChecked('muted')} className="rounded mr-2" />
