...
const ConversationItem = ({
  ...
  return (
    <button
      ...
      className={clsx('group flex w-full items-center gap-3 px-4 py-2.5 text-left transition-colors', {
        'bg-neutral-100 dark:bg-zinc-700': isHighlighted,
        'text-zinc-700 hover:bg-neutral-50 dark:text-zinc-300 dark:hover:bg-zinc-700/50': !isHighlighted
      })}
    >
      <span
        className={clsx(
      ...
      <span className="min-w-0 flex-1">
        <span className="flex items-center gap-2">
          ...
          <span
            className={clsx('block truncate text-[12px] font-medium', {
              'text-zinc-900 dark:text-zinc-100': isHighlighted,
              'text-zinc-700 dark:text-zinc-300': !isHighlighted
            })}
          >
