...
const ResourceImage = ({ className, title, src, removing, onClick, onRemove }: ResourceImageProps) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <img draggable={false} src={src} alt={title} className="aspect-video h-full w-full" />
