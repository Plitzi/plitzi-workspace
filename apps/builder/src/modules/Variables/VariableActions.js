...
const VariableActions = ({ onUpdate, onRemove, selected }) => (
  ...
  >
    <Button intent="custom" size="custom" border="none" onClick={onUpdate} title="Update" content="">
      <Button.Icon intent="primary" icon="fas fa-pen" />
    </Button>
    <Button intent="custom" border="none" size="custom" onClick={onRemove} title="Remove" content="">
