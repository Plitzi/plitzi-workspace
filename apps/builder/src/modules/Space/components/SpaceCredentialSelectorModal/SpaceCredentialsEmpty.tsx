...
const SpaceCredentialsEmpty = ({ children }: SpaceCredentialsEmptyProps) => {
  return (
    <div className="flex flex-col items-center justify-center gap-6 rounded border border-dashed border-gray-300 p-10">
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <Text className="text-gray-400">Add your first credential to start managing your credentials</Text>
      </div>
      {children}
    </div>
  );
