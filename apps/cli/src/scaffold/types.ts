...
export interface PluginAnswers {
  /** The package name, from which every other name of the plugin is derived (see `pluginNames`). */
  packageName: string;
  /** What the builder's catalogue shows, and the element's label until somebody renames it. */
  title: string;
