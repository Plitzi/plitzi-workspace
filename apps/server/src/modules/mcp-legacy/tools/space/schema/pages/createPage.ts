...
const outputSchema = elementSchema.describe('The created page');
...
const createPageTool: McpTool = {
  ...
  mcpDefinition: {
    title: 'Create Page',
    description:
      'Create a new page in the space. Returns the page element — use its id to add child elements via create_element.',
    inputSchema,
    outputSchema
  },
  definition: {
