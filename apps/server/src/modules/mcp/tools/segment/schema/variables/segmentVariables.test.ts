...
describe('createSegmentVariableTool', () => {
  ...
  describe('inputSchema', () => {
    it('accepts segmentId and valid variable', () => {
      expect(
        createSegmentVariableTool.mcpDefinition.inputSchema?.safeParse({ segmentId: 'seg-1', variable: validVariable })
          .success
      ).toBe(true);
    });

    it('rejects missing segmentId', () => {
      expect(createSegmentVariableTool.mcpDefinition.inputSchema?.safeParse({ variable: validVariable }).success).toBe(
        false
      );
    });
  ...
  describe('outputSchema', () => {
    it('validates created variable', () => {
      expect(createSegmentVariableTool.mcpDefinition.outputSchema?.safeParse(validVariable).success).toBe(true);
    });
  });
});
...
describe('updateSegmentVariableTool', () => {
  ...
  describe('outputSchema', () => {
    it('validates updated variable', () => {
      expect(updateSegmentVariableTool.mcpDefinition.outputSchema?.safeParse(validVariable).success).toBe(true);
    });
  });
});
...
describe('deleteSegmentVariableTool', () => {
  ...
  describe('inputSchema', () => {
    ...
    it('rejects missing name', () => {
      expect(deleteSegmentVariableTool.mcpDefinition.inputSchema?.safeParse({ segmentId: 'seg-1' }).success).toBe(
        false
      );
    });
  });
  ...
  describe('outputSchema', () => {
    it('validates data: true', () => {
      expect(deleteSegmentVariableTool.mcpDefinition.outputSchema?.safeParse(true).success).toBe(true);
    });
  });
});
