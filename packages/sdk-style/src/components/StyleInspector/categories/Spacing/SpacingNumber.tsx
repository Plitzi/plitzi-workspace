  ...
  return (
    <div
      className={clsx('mx-0.5 flex w-[30px] items-center justify-center rounded-md border px-0.5 text-xs', {
        'border-transparent hover:border-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:text-blue-400 dark:hover:text-blue-400': !active,
        'border-blue-300 bg-blue-100 dark:bg-blue-900/50 text-blue-400': active
      })}
