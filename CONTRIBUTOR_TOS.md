...
To the extent that your Contribution includes patentable material, you grant Plitzi and recipients of the software a **perpetual, worldwide, royalty-free patent license** to make, use, sell, offer for sale, import, and otherwise run, modify, and distribute the Contribution as part of the project.
...
Plitzi is under **no obligation** to accept, review, merge, or distribute any Contribution.

Submitting a Contribution does **not guarantee** that it will be included in the project.

---

## 7. Code of Conduct

All Contributions must comply with the Plitzi **Code of Conduct**, if one is present in the repository.
